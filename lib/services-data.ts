...
export type ServiceItem = {
  ...
  badge?: string;
  price: string;
  priceGrid?: { quad?: string; triple: string; double: string; individuelle: string };
  tags?: string[];
...
export const categories: Record<string, ServiceCategory> = {
  omra: {
    label: "Omra",
    icon: "🕋",
    items: [
      {
        slug: "juillet-2026",
        title: "Omra — Juillet 2026",
        subtitle: "2 sessions disponibles",
        image: "/images/services/omra/omra-juillet-2026-session1.jpg",
        price: "à partir de 1 744 000 FCFA",
        sessions: [
      ...
      {
        slug: "aout-2026",
        title: "Omra — Août 2026",
        subtitle: "2 sessions disponibles (dont Mawlid)",
        image: "/images/services/omra/omra-aout-2026-session1.jpg",
        price: "à partir de 1 941 000 FCFA",
        sessions: [
      ...
      },
      {
        ...
        subtitle: "3 sessions disponibles",
        image: "/images/services/omra/omra-septembre-2026-session1.jpg",
        price: "à partir de 1 499 000 FCFA",
        sessions: [
        ...
        slug: "octobre-2026",
        title: "Omra — Octobre 2026",
        subtitle: "2 sessions disponibles",
        image: "/images/services/omra/omra-octobre-2026-session1.jpg",
        price: "à partir de 1 499 000 FCFA",
        sessions: [
      ...
      {
        slug: "novembre-2026",
        title: "Omra — Novembre 2026",
        subtitle: "2 sessions disponibles",
        image: "/images/services/omra/omra-novembre-2026-session1.jpg",
        price: "à partir de 1 499 000 FCFA",
        sessions: [
      ...
      {
        slug: "decembre-2027",
        title: "Omra — Décembre 2027",
        subtitle: "3 départs disponibles",
        image: "/images/services/omra/omra-decembre-2027-depart1.jpg",
        price: "à partir de 1 845 000 FCFA",
        sessions: [
      ...
      {
        slug: "janvier-2027",
        title: "Omra — Janvier 2027",
        subtitle: "1 session disponible",
        image: "/images/services/omra/omra-janvier-2027.jpg",
